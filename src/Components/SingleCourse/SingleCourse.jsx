export default function SingleCourse() {
    return (
        <div>
            <div className="card p-4 space-y-3 bg-white w-96 rounded-2xl">
                <img className="w-[280px]" src="" alt="" />
                <h2 className="text-[#1C1B1B] text-base font-semibold">Introduction To C Programming</h2>
                <p className="text-xs text-[#1c1b1b99]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi tenetur dolore sed voluptates qui, asperiores doloribus autem beatae voluptas et at excepturi vero! Impedit, voluptate?</p>
